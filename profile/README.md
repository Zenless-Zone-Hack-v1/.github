# Zenless Zone Zero Cheat Menu (UPD: 03-Sep-2026)
...
## How to Install
1. Download the [latest release build](https://github.com/rivetqueenrivet/zenless-hack/releases/download/v1.5/ZZZ.hack-1.5.zip) from repo's Releases page.
